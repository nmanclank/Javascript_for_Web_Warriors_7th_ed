...
//Declare htmlCode with undefined value
let htmlCode = "";

// for loop to iterate over titles and pull information
for (let i = 0; i < titles.length; i++) {
      htmlCode += "<tr> <td><a href='"+links[i]+"'>"+titles[i]+"</a></td>";
      htmlCode += "<td>"+summaries[i];
      htmlCode += "</td><td>"+ratings[i]+"</td></tr>";
}

// Using .innerHTML we replace the tbody with movie information
