...
//for loop to iterate over reviews  
for (let i = 0; i < reviewers.length; i++) {
      let reviewCode = "";
      // conditional logic for table class  
      if (reviewType[i] === "P") {
...
//declare variable to store article tag
let reviewAddHere = document.getElementsByTagName("article")[0];
//insert html for review
reviewAddHere.insertAdjacentHTML("beforeEnd", reviewCode);
}
